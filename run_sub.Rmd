...
# Load dataset
sc10x.data <- Read10X(data.dir = "./dataset/subsampling-5c/50/filtered_feature_bc_matrix")
...
writeMM(obj = sparse.sce, file="./dataset/subsampling-5c/50-after/matrix.mtx")

# save genes and cells names
write(x = rownames(sce), file = "./dataset/subsampling-5c/50-after/genes.tsv")
write(x = colnames(sce), file = "./dataset/subsampling-5c/50-after/barcodes.tsv")
```

# Start Running

```{r}
path = "./cluster_results/subsampling-5c/50/"
```
