...
# Load dataset
sc10x.data <- Read10X(data.dir = "./dataset/subsampling-5c/70/filtered_feature_bc_matrix")
...
```{r}
sc10x <- subset(sc10x, subset = nFeature_RNA > 1000 & nFeature_RNA < 6000 & percent.mt < 5) #1000-7000
```
...
writeMM(obj = sparse.sce, file="./dataset/subsampling-5c/70-after/matrix.mtx")

# save genes and cells names
write(x = rownames(sce), file = "./dataset/subsampling-5c/70-after/genes.tsv")
write(x = colnames(sce), file = "./dataset/subsampling-5c/70-after/barcodes.tsv")
```

# Start Running

```{r}
path = "./cluster_results/subsampling-5c/70/"
```
